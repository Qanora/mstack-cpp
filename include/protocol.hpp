...
class protocol_interface {
 ...
 public:
  ...
  std::optional<packet_receiver_current_layer_type>
      _forward_to_current_layer_func;

  virtual int proto() { return 0x0000; }

  virtual std::string tag() { return "NULL PROTO"; }
  ...
  void register_forward_layer(
      packet_receiver_current_layer_type forward_to_current_layer_func) {
